import svgPaths from "./svg-yx51g1hy7j";

function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-center relative shrink-0 w-[43px]">
      ...
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 43 1">
            <line id="Line 10" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="43" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame10() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <Frame1 />
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[16px] w-full">{`Inter is a very popular typeface, but, fun fact i don't like inter i feel like its ugly. I picked it to challenge myself. Did i do a good job?`}</p>
    </div>
  );
}
...
function Frame11() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#2a2a2a] text-[18px] w-full">Typography</p>
      <Frame10 />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[18px] w-full">Adefaye Oluwaseun</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 172.003 1">
            <line id="Line 6" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="172.003" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[98.005px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[18px] w-full">aydahnizzy</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 98.0051 1">
            <line id="Line 7" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="98.0051" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[129px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[18px] w-full">Shater Tsavsar</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 129 1">
            <line id="Line 8" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="129" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[157px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[18px] w-full">Oluwafemi Soetan</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 157 1">
            <line id="Line 9" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="157" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame6() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[112px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#171717] text-[18px] w-full">Rachel Chen</p>
      <div className="h-0 relative shrink-0 w-full">
        <div className="absolute inset-[-1px_0_0_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 112 1">
            <line id="Line 9" stroke="var(--stroke-0, #5C5C5C)" strokeDasharray="2 2" x2="112" y1="0.5" y2="0.5" />
          </svg>
        </div>
      </div>
    </div>
...
function Frame15() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[172.004px]">
      <Frame2 />
      <Frame3 />
      <Frame4 />
      <Frame5 />
  ...
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <div className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] min-w-full not-italic relative shrink-0 text-[#171717] text-[18px] w-[min-content]">
        <p className="mb-0">{`This guys helped me make sense of the ideas in my head, they gave me `}</p>
        <p>template and guidelines to run with.</p>
      </div>
      <Frame15 />
    </div>
  );
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[#2a2a2a] text-[18px] w-full">Inspiration</p>
      <Frame7 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="content-stretch flex gap-[171px] items-start relative shrink-0">
      <Frame9 />
      <Frame12 />
    </div>
  );
...
function Frame14() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[206px] items-center justify-center left-0 top-[83px] w-[1440px]">
      <Frame13 />
      <Frame />
    </div>
  );
...
export default function Colophon1() {
  return (
